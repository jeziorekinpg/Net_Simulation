...
public:
  ...
  [[nodiscard]] NodeCollection<Ramp>::const_iterator find_ramp_by_id(ElementID id) const {return list_ramp.find_by_id(id);};
  ...
  [[nodiscard]] NodeCollection<Worker>::const_iterator find_worker_by_id(ElementID id) const {return list_worker.find_by_id(id);};
  ...
  [[nodiscard]] NodeCollection<Storehouse>::const_iterator find_storehouse_by_id(ElementID id) const {return list_storehouse.find_by_id(id);};
  [[nodiscard]] NodeCollection<Storehouse>::const_iterator storehouse_cbegin() const {return list_storehouse.cbegin();};
